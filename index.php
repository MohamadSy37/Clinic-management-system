...
<div class="login-box">
  <div class="login-logo mb-4">
    ...
    <div class="text-center h2 mb-0">نظام ادارة مرضئ العيادة الطبية</div>
  </div>
  <!-- /.login-logo -->
    ...
    <div class="card-body login-card-body">
      ...
      <form method="post">
        <div class="input-group mb-3">
          ...
          placeholder="اسم المستخدم" id="user_name" name="user_name">
        ...
        <div class="row">
          <div class="col-12">
            <button name="login" type="submit" class="btn btn-primary rounded-0 btn-block">تسجيل دخول</button>
          </div>
          <!-- /.col -->
        </div>
